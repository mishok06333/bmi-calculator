"""!
@file bmi.py
@brief Module for calculating body mass index (BMI)
"""

def calculate_bmi(weight, height):
    """!
    @brief Calculate BMI (Body Mass Index)
...
def get_bmi_category(bmi):
    """!
    @brief Get BMI category based on BMI value
...
def calculate_ideal_weight(height, target_bmi=22):
    """!
    @brief Calculate ideal weight for given height and target BMI
...
def validate_input(weight, height):
    """
    @brief Validate weight and height inputs
